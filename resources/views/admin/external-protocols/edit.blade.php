        ...
        <form action="{{ route('admin.external-protocols.update', $externalProtocol) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                @if($externalProtocol->image)
                    <div class="mb-4">
                        <img src="{{ asset($externalProtocol->image) }}" alt="Current Image" style="object-fit: contain; max-width: 100%; max-height: 100%; border-radius: 12px; background: #f8f9fa; width: 128px; height: 128px;">
