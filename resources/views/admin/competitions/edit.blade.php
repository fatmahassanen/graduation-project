...
<div class="max-w-4xl mx-auto">
    <x-admin.page-header 
        ...
        description="Update competition card information"
    />
        ...
        <form action="{{ route('admin.competitions.update', $competition) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                @if($competition->image)
                    <div class="mb-4">
                        <img src="{{ asset($competition->image) }}" alt="Current Image" style="object-fit: contain; max-width: 100%; max-height: 100%; border-radius: 12px; background: #f8f9fa; width: 192px; height: 192px;">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    name="order" 
                    id="order"
                    value="{{ old('order', $competition->order) }}"
                    min="0"
