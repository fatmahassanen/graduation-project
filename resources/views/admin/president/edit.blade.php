        ...
        <x-admin.card>
            <form action="{{ route('admin.president.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    @if($president->image)
                        <div class="mb-4">
                            <img src="{{ asset($president->image) }}" alt="Current President Image" style="object-fit: contain; max-width: 100%; max-height: 100%; border-radius: 12px; background: #f8f9fa; width: 128px; height: 128px;">
