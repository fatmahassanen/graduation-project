...
<div class="max-w-4xl mx-auto">
    <x-admin.page-header 
        title="Edit Graduate Achievement" 
        description="Update graduate achievement card information"
    />

    <x-admin.card>
        <form action="{{ route('admin.graduates.update', $graduate) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    name="title" 
                    id="title"
                    value="{{ old('title', $graduate->title) }}"
                    required
            ...
            <div class="mb-6">
                ...
                >{{ old('description', $graduate->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                @if($graduate->image)
                    <div class="mb-4">
                        <img src="{{ asset($graduate->image) }}" alt="Current Image" style="object-fit: contain; max-width: 100%; max-height: 100%; border-radius: 12px; background: #f8f9fa; width: 192px; height: 192px;">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    name="order" 
                    id="order"
                    value="{{ old('order', $graduate->order) }}"
                    min="0"
            ...
            <div class="mb-6">
                <label class="flex items-center cursor-pointer">
                    <input 
                        ...
                        id="is_active"
                        value="1"
                        {{ old('is_active', $graduate->is_active) ? 'checked' : '' }}
