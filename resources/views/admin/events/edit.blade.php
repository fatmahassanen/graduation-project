        ...
        <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            @if($event->image)
                <div>
                    ...
                    <img src="{{ asset($event->image) }}" alt="{{ $event->title }}" style="object-fit: contain; max-width: 100%; max-height: 100%; border-radius: 12px; background: #f8f9fa; width: 192px; height: 192px;">
                </div>
            @endif
