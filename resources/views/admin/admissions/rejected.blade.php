...
<div class="max-w-7xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Rejected Applications</h1>
    ...
    <div class="bg-white rounded-lg shadow-lg p-12 text-center">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No Rejected Applications</h3>
        <p class="text-gray-500">Rejected applications will appear here</p>
    </div>
    @else
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-red-500 to-pink-600">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Rejected Date</th>
                        <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Reason</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">
                            ...
                            <span class="text-gray-700">{{ Str::limit($admission->rejection_reason, 50) }}</span>
                            @else
    ...
    <div class="mt-6 bg-white rounded-lg shadow p-4">
        <div class="flex items-center justify-between text-sm text-gray-600">
            <span>Total Rejected Applications: <strong class="text-red-600">{{ $admissions->count() }}</strong></span>
        </div>
    </div>
    @endif
</div>
