    ...
    public function run(): void
    {
        ...
        $events = [
            ...
            [
                ...
                'category' => 'competition',
                'image_id' => null,
                'featured_image' => 'img/Events/CO.jpg',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'published',
                'created_by' => $editor->id,
            ...
            [
                ...
                'category' => 'competition',
                'image_id' => null,
                'featured_image' => 'img/Events/co2.jpg',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'published',
                'created_by' => $admin->id,
            ...
            [
                ...
                'category' => 'conference',
                'image_id' => null,
                'featured_image' => 'img/Events/conf1.png',
                'is_recurring' => true,
                'recurrence_rule' => 'FREQ=YEARLY;INTERVAL=1',
                'language' => 'en',
                'status' => 'published',
            ...
            [
                ...
                'category' => 'exhibition',
                'image_id' => null,
                'featured_image' => 'img/Events/Exh.jpg',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'published',
                'created_by' => $editor->id,
            ...
            [
                ...
                'category' => 'exhibition',
                'image_id' => null,
                'featured_image' => 'img/Events/ex1.jpg',
                'is_recurring' => true,
                'recurrence_rule' => 'FREQ=YEARLY;INTERVAL=1',
                'language' => 'en',
                'status' => 'published',
            ...
            [
                ...
                'category' => 'seminar',
                'image_id' => null,
                'featured_image' => 'img/Events/PR.jpg',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'published',
                'created_by' => $admin->id,
            ...
            [
                ...
                'category' => 'seminar',
                'image_id' => null,
                'featured_image' => 'img/Events/PR2.jpg',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'published',
                'created_by' => $admin->id,
            ...
            [
                ...
                'category' => 'seminar',
                'image_id' => null,
                'featured_image' => 'img/Events/PR3.jpg',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'published',
                'created_by' => $admin->id,
            ...
            [
                ...
                'category' => 'conference',
                'image_id' => null,
                'featured_image' => 'img/Events/conf2.png',
                'is_recurring' => false,
                'language' => 'en',
                'status' => 'draft',
                'created_by' => $admin->id,
