...
class BotResponseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $responses = [
            ...
            ['keyword' => 'كليات','reply' => "🏛️ كليات جامعة القاهرة الجديدة التكنولوجية (NCTU):\n\n🔹 كلية تكنولوجيا الصناعة والطاقة:\n• تكنولوجيا المعلومات والاتصالات (ICT)\n• الميكاترونكس (Mechatronics)\n• الأوتوترونكس (Autotronics)\n• الطاقة المتجددة (Renewable Energy)\n• تكنولوجيا إنتاج البترول (Petroleum Production)\n\n🔹 كلية تكنولوجيا العلوم الصحية:\n• الأطراف الصناعية والأجهزة التعويضية (Prosthetics & Orthotics)\n\n──────────────────\n💡 لمعرفة تفاصيل أكثر عن كل قسم، تفضل بزيارة صفحة Departments."],
            ['keyword' => 'قسم','reply' => "🏛️ أقسام جامعة القاهرة الجديدة التكنولوجية (NCTU):\n\n1️⃣ تكنولوجيا المعلومات والاتصالات (ICT)\n2️⃣ الميكاترونكس (Mechatronics)\n3️⃣ الأوتوترونكس (Autotronics)\n4️⃣ الطاقة المتجددة (Renewable Energy)\n5️⃣ تكنولوجيا إنتاج البترول (Petroleum Production)\n6️⃣ الأطراف الصناعية والأجهزة التعويضية (Prosthetics & Orthotics)\n\n──────────────────\n💡 يمكنك تصفح تفاصيل كل قسم من قائمة Departments."],
            ['keyword' => 'اقسام','reply' => "🏛️ الهيكل الأكاديمي لجامعة القاهرة الجديدة التكنولوجية (NCTU):\n\n🏢 كلية تكنولوجيا الصناعة والطاقة:\n• ICT | الميكاترونكس | الأوتوترونكس\n• الطاقة المتجددة | إنتاج البترول\n\n🏥 كلية تكنولوجيا العلوم الصحية:\n• الأطراف الصناعية والأجهزة التعويضية\n\n──────────────────\n💡 للمزيد من التفاصيل، يرجى زيارة صفحة Departments."],
            ...
            ['keyword' => 'ازيك', 'reply' => 'الحمد لله! أهلاً بك في موقع جامعة القاهرة الجديدة التكنولوجية، كيف يمكنني مساعدتك اليوم؟'],
            ...
            ['keyword' => 'اهلا', 'reply' => 'أهلاً بك في موقع جامعة القاهرة الجديدة التكنولوجية (NCTU)! كيف يمكنني مساعدتك اليوم؟'],
            ['keyword' => 'مرحبا', 'reply' => 'مرحباً بك في موقع الجامعة! يسعدني مساعدتك في معرفة شروط التقديم، المصاريف، أو معلومات الأقسام.'],
            ...
            // ==========================================================
            // [17. NEW SMART Q&A ADDITIONS (Enterprise Level)]
            // ==========================================================
            ['keyword' => 'فرق هندسة', 'reply' => 'كليات الهندسة والحاسبات تركز على التصميم والتطوير من الصفر. أما الجامعة التكنولوجية، فتركز على تشغيل، صيانة، وتطبيق الأنظمة تكنولوجياً وفنياً في المصانع. التكنولوجي هو الحلقة الواصلة بين المهندس الأكاديمي والفني.'],
            ['keyword' => 'معتمدة', 'reply' => 'نعم، جامعة القاهرة الجديدة التكنولوجية هي جامعة حكومية مصرية منشأة بقرار جمهوري ومعتمدة تماماً من المجلس الأعلى للجامعات ووزارة التعليم العالي.'],
            ['keyword' => 'نقابة', 'reply' => 'الخريج يتم قيده في نقابة التكنولوجيين المصرية الرسمية، وهي النقابة المهنية المنشأة خصيصاً لحماية حقوق الخريجين وتحديد مسمياتهم الوظيفية بسوق العمل.'],
            ['keyword' => 'دراسات عليا', 'reply' => 'نعم، تتيح الجامعة برامج الماجستير المهني والدكتوراه التكنولوجية في التخصصات المختلفة، كما يمكنك التقديم في الجامعات التكنولوجية الدولية بالخارج.'],
            ['keyword' => 'عربي ولا انجليزي', 'reply' => 'الدراسة باللغة الإنجليزية لمواكبة سوق العمل العالمي، لكن الجامعة توفر كورسات مكثفة في اللغة الإنجليزية التقنية في السنة الأولى لمساعدة الطلاب.'],
            ['keyword' => 'حضور', 'reply' => 'الحضور للورش والمعامل والمصانع إجباري وله نسبة غياب صارمة، فالعملي يتطلب التواجد الواقعي.'],
            ['keyword' => 'شركات', 'reply' => 'الجامعة متعاقدة مع كبرى القلاع الصناعية والبرمجية في مصر (مثل الهيئة العربية للتصنيع، وشركات بترول وسيارات كبرى). التدريب الصيفي إجباري تماماً من نهاية السنة الأولى.'],
            ['keyword' => 'مبرمج ولا شبكات', 'reply' => 'تخصص الـ ICT بالجامعة يغطي شقين: تطوير البرمجيات والمواقع، وإدارة الشبكات والأمن السيبراني والأنظمة المدمجة. الأماكن المتاحة تشمل شركات البرمجيات والمصانع الذكية.'],
            ['keyword' => 'مواصلات', 'reply' => 'تقع الجامعة في اللوتس الجنوبية، التجمع الخامس. يمكن الوصول إليها عبر مواصلات التجمع الخامس المتوفرة من محطة مترو حلوان أو موقف المنيب أو رمسيس.'],
            ['keyword' => 'أنشطة طلابية', 'reply' => 'نعم، يوجد اتحاد طلاب قوي، والعديد من الأنشطة الرياضية، الفنية، والتكنولوجية، بالإضافة إلى تنظيم حفلات تخرج ومسابقات دورية.'],
            ['keyword' => 'احول', 'reply' => 'التحويل متاح وفقاً لقواعد المجلس الأعلى للجامعات في نهاية العام الدراسي الأول بشرط استيفاء الحد الأدنى للكلية المراد التحويل إليها.'],
            ['keyword' => 'ادبي', 'reply' => 'الكلية تقبل طلاب الشعبة العلمية فقط (علمي علوم وعلمي رياضة)، بالإضافة إلى طلاب الدبلومات الفنية والمعاهد التكنولوجية. لا تقبل شعبة أدبي.'],
            ['keyword' => 'دبلومات', 'reply' => 'نعم، الجامعة تقبل طلاب الثانوية الأزهرية، ومدارس STEM، والدبلومات الفنية (نظام 3 و5 سنوات). النسبة الأكبر مخصصة للتعليم الفني.'],
            ['keyword' => 'كام سنة', 'reply' => 'مدة الدراسة 4 سنوات. تمنح الجامعة دبلوم عالي تكنولوجي بعد أول سنتين، أو بكالوريوس تكنولوجيا في التخصص بعد إتمام الـ 4 سنوات كاملة.'],

            ['keyword' => 'صعبة', 'reply' => 'الدراسة في جامعة NCTU ممتعة وتعتمد على ميولك؛ طالما لديك شغف بالتكنولوجيا والجانب العملي، ستجدها مفيدة جداً. الجامعة توفر معامل مجهزة ونخبة من أعضاء هيئة التدريس لمساعدتك، ونظام التقييم البريطاني (Pearson) يجعلك تتعلم من خلال المشاريع التي تحاكي بيئة العمل الحقيقية.'],
            ['keyword' => 'صعب', 'reply' => 'الدراسة في جامعة NCTU ممتعة وتعتمد على ميولك؛ طالما لديك شغف بالتكنولوجيا والجانب العملي، ستجدها مفيدة جداً. الجامعة توفر معامل مجهزة ونخبة من أعضاء هيئة التدريس لمساعدتك، ونظام التقييم البريطاني (Pearson) يجعلك تتعلم من خلال المشاريع التي تحاكي بيئة العمل الحقيقية.'],
            ['keyword' => 'بتبيعوا', 'reply' => 'الجامعة مؤسسة تعليمية حكومية غير تجارية. نحن لا نبيع منتجات، بل نقدم معرفة ومهارات تكنولوجية من خلال برامج أكاديمية معتمدة. هدفنا هو تخريج متخصصين مؤهلين لسوق العمل، وهذا هو الاستثمار الحقيقي للطالب في مستقبله.'],
            ['keyword' => 'بتبيعوا إيه', 'reply' => 'الجامعة مؤسسة تعليمية حكومية غير تجارية. نحن لا نبيع منتجات، بل نقدم معرفة ومهارات تكنولوجية من خلال برامج أكاديمية معتمدة. هدفنا هو تخريج متخصصين مؤهلين لسوق العمل، وهذا هو الاستثمار الحقيقي للطالب في مستقبله.'],
